...
public class FrmSanPham extends javax.swing.JFrame {
    ...
    private ISanPhamService service = new SanPhamService() ;
    ...
    private void loadDataToTable() {
        List<ViewSanPham> list = service.findAll();
        String[] columns = {"Mã", "Tên"};
        dtm.setColumnIdentifiers(columns);
        tbHienThi.setModel(dtm);
        dtm.setRowCount(0);
        for (ViewSanPham view : list) {
            dtm.addRow(view.toDaTaRow());
        }
    }

    private ViewSanPham getProductFromInput() { // lấy đối tượng chức vụ từ input
        ViewSanPham x = new ViewSanPham();
    ...
    public void fill(int index) {
        ViewSanPham view = service.findAll().get(index);
    ...
    private void btnNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewActionPerformed
        ...
        ViewSanPham x = getProductFromInput();
