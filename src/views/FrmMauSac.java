...
public class FrmMauSac extends javax.swing.JFrame {
    ...
    private IMauSacService service = new MauSacService();
    ...
    private void loadDataToTable() {
        List<ViewMauSac> list = service.findAll();
        String[] columns = {"Mã", "Tên"};
        dtm.setColumnIdentifiers(columns);
        tbHienThi.setModel(dtm);
        dtm.setRowCount(0);
        for (ViewMauSac view : list) {
            dtm.addRow(view.toDaTaRow());
        }
    }

    private ViewMauSac getProductFromInput() { // lấy đối tượng chức vụ từ input
        ViewMauSac x = new ViewMauSac();
    ...
    public void fill(int index) {
        ViewMauSac view = service.findAll().get(index);
    ...
    private void btnNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewActionPerformed
        ...
        ViewMauSac x = getProductFromInput();
